...
- type of subscription (FIX, MOBILE, FIBRE), date of subscription, id client
- a subscription can have one or more options : name (ROAMING, NETFLIX) and a date of susbscription.

To manage this subscription we need 2 routes :
